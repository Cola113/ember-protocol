  ...
  return (
    <div className="fixed inset-0 z-50 bg-void/90 backdrop-blur-xl flex flex-col items-center justify-center p-6 overflow-hidden pointer-events-auto animate-fadeIn">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        ...
        <div className="absolute w-[500px] h-[500px] rounded-full border border-holo-amber/40 animate-ping" style={{ animationDuration: "3s" }} />
        <div className="absolute w-[700px] h-[700px] rounded-full border border-holo-cyan/20 animate-spin" style={{ animationDuration: "40s" }} />
      </div>
      ...
      <div className="relative z-10 max-w-2xl w-full holo-panel p-8 md:p-10 rounded-sm border-holo-amber/60 shadow-holo-amber">
        ...
        <div className="flex justify-between items-center border-b border-holo-cyan/20 pb-4 mb-6">
          <div className="flex items-center gap-2 text-holo-amber font-mono font-bold text-xs tracking-widest uppercase">
            ...
            <span>ANCHOR TRUTH BELIEVED // 锚定真相确证</span>
          </div>
        ...
        <div className="mb-4">
          ...
          <h2 className="font-display font-bold text-2xl md:text-3xl text-holo-bright mt-1">
            {truth.title}
          </h2>
        </div>
              ...
              {unlockedPlanetDefs.map((planet) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-holo-cyan font-mono">{planet.true_compute_role}</div>
                  </div>
                </div>
              ))}
            </div>
